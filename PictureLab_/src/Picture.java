...
public class Picture extends SimplePicture 
{
  ...
  public void createCollage()
  {
    ...
    this.copy2(beach,162,244,298,411);
  }
  
  public void myCollage()
  {
    Picture flower = new Picture("arch.jpg");
    Picture flower1 = flower.scale(0.468, 0.35);
    Picture flower2 = new Picture("femaleLionAndHall.jpg");
    Picture beach = new Picture("beach.jpg");
  ...
  {
    Picture lh = new Picture("femaleLionAndHall.jpg");
    lh.explore();
    lh.zeroBlue();
    lh.explore();
  }
